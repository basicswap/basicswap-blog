...
![A HTLC (or 'secret hash') atomic swap.](/basicswap-blog/images/blog/htlc_swap_schema_decred.png)
...
![An 'adaptor sig' atomic swap, from the Offerer's perspective.](/basicswap-blog/images/blog/adaptor_signature_swap_schema_bsx.png)
...
![Dr. Danny Duberstein accomplishing a BTC->XMR adaptor sig atomic swap for the first time (allegedly)](/basicswap-blog/images/blog/voila.png)
